...
class TransportParametersTest {
  ...
  fun smoke() {
    ...
    val params = TransportParameters(Constants.Role.CLIENT, test)
    Logging.log(params)
    assertEquals(2097152, params.initMaxStreamDataBidiLocal)
    assertEquals(1048576, params.initMaxData)
  }
}
