...
open class JWTSignWithAppleOtherTokenGenerator : Generator() {
  ...
  override fun generate(inputData: String): String {
    ...
    val dlg = JDialog(GUIMain.getInstance())

    val rect = GUIMain.getInstance().bounds
    val width = 300
    val height = 150
    dlg.setBounds(
    ...
    GUIMain.getInstance().isAlwaysOnTop = true
    GUIMain.getInstance().isVisible = true
    ...
    GUIMain.getInstance().isAlwaysOnTop = false
