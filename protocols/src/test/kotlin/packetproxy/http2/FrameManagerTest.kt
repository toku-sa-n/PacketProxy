...
class FrameManagerTest {
  private val requestFrames: ByteArray
  private val responseFrames: ByteArray
  private val settingsFrame: ByteArray
  ...
  init {
    ...
    settingsFrame =
      Hex.decodeHex("000012040000000000000300000064000400100000000600004000".toCharArray())
  }
